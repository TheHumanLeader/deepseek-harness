...
The tab renders a searchable two-column catalog of disclosure cards. Expanding a card shows its purpose, features and tools, read/change/send behavior, network and credential requirements, Agent access, runtime state, unavailable reason, and documentation link. Search covers the module name, Loader entry id, purpose, and features.
