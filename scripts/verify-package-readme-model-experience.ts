...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-agent-guidance': { kind: 'indirect', reason: 'Browser-side settings page; dsh-agent-guidance owns every model-visible snapshot and helper-Agent resolution.' },
