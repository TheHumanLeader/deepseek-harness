...
flowchart LR
  ...
  plugin_dsh_base_agent_guidance["agent-guidance<br/>@deepseek-ai/dsh-agent-guidance"]
  cfg --> plugin_dsh_base_agent_guidance
...
| `agent-guidance` | `@deepseek-ai/dsh-agent-guidance` |
